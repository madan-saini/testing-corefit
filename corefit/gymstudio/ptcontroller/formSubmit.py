...
def basicProfile(request):
    ...
    print('id1',basic_info_id)
    print('id2',basic_info_id2)
    if files:
    ...
    print('ba1',basicInfo)
    print('ba1',basicInfo.id)

    print('ba2',basicInfo2)
...
#         # print(1)
#         return render(request, 'ptTemplates/elements/users/media_table.html', context)
#     if myMedia != '':
#         fss = FileSystemStorage()
...
#     }
#     return render(request, 'ptTemplates/elements/myProfile/clientTransformation.html', context)
#
...
#         'userClientTransformationData': userClientTransformationData
#     }
#     return render(request, 'ptTemplates/elements/users/client_table.html', context)
#
...
#     }
#     return render(request, 'ptTemplates/elements/users/faq_table.html', context)
...
#         'mediaSoci': mediaSoci,
#     }
#     return render(request, 'ptTemplates/elements/users/mediaModel.html', context)
# def viewFaq(request):
#     data = request.POST
#     user_id = request.session['user_id']
#     id = data.get("id")
...
#     }
#     return render(request, 'ptTemplates/elements/users/faqModel.html', context)
...
#     }
#     return render(request, 'ptTemplates/elements/users/clientModal.html', context)
