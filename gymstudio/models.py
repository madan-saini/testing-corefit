...
class Request(models.Model):
    ...
    gym_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='gym_user')
    freelancer_user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='freelancer_user')
